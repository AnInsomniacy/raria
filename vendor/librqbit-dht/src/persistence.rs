...
impl PersistentDht {
    ...
    pub fn dump_now(dht: &Dht, config_filename: Option<PathBuf>) -> anyhow::Result<()> {
        ...
        dump_dht(dht, &config_filename, &tempfile_name)
    }
                ...
                dht.cancellation_token().clone(),
                {
                    ...
                    async move {
                        loop {
                            ...
                            match Self::dump_now(&dht, Some(config_filename.clone())) {
