...
struct RuntimeEd2kConfig {
    ...
    listen_tcp_port: u16,
    listen_udp_port: u16,
    assume_firewalled: bool,
    use_default_servers: bool,
    servers: Vec<String>,
    server_met_paths: Vec<std::path::PathBuf>,
    nodes_dat_paths: Vec<std::path::PathBuf>,
    use_local_nodes_dat: bool,
...
async fn handle_config(
    ...
    Ok(Json(RuntimeConfigResponse {
        ...
        ed2k: RuntimeEd2kConfig {
            ...
            use_default_servers: config.ed2k_use_default_servers,
            servers: config.ed2k_servers.clone(),
            server_met_paths: config.ed2k_server_met_paths.clone(),
            nodes_dat_paths: config.ed2k_nodes_dat_paths.clone(),
            use_local_nodes_dat: config.ed2k_use_local_nodes_dat,
