...
| `ed2k-native/overview.md` | Native ED2K/eMule evidence tracker, delegated from this completed core tracker |
...
| ED2K/eMule | Native Rust support is tracked under `ed2k-native`; it is separate from the completed CM-001 through CM-022 baseline |
